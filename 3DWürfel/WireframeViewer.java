...
public class WireframeViewer extends Applet
   ...
   public void init() {
      ...
      edges[12] = new Edge( 8, 7 );
      edges[13] = new Edge( 0, 8 );
   ...
   void drawWireframe( Graphics g ) {
      ...
      for ( j = 0; j < edges.length; ++j ) {
         ...
         g.fillOval(
            points[ edges[j].a ].x - 5, points[ edges[j].a ].y - 5,
            10,10
         );
         g.fillOval(
            points[ edges[j].b ].x - 5, points[ edges[j].b ].y - 5,
            10,10
         );
      }
   }
